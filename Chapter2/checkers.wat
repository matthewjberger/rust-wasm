(module
 ...
 ;;     - removing an opponent piece during a jump
 ...
 (func $initBoard
       ...
       ;; 3rd row
       (call $setPiece (i32.const 17) (i32.const 0) (i32.const 2))
       (call $setPiece (i32.const 19) (i32.const 0) (i32.const 2))
       (call $setPiece (i32.const 21) (i32.const 0) (i32.const 2))
       (call $setPiece (i32.const 23) (i32.const 0) (i32.const 2))
       ...
       (call $setPiece (i32.const 62) (i32.const 0) (i32.const 1))
